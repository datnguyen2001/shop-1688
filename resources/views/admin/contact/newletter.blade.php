                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 d-flex justify-content-end">
                                <form class="d-flex align-items-center w-50" method="get"
                                      action="{{route('admin.contact-newsletter')}}">
                                    ...
                                    <a href="{{route('admin.contact-newsletter')}}" class="btn btn-danger" style="margin-left: 15px">Hủy </a>
                                </form>
                            </div>
                            @if(count($listData) > 0)
                                <table class="table">
                                    ...
                                    @foreach($listData as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{url('admin/contact-newsletter-delete/'.$value->id)}}"
